public class Main {
	...
	// auch zur Berechnung der Kollision bentigt
	...
	private static int bombencounter = 0;// zhlt die anzahl der bomben
	...
	private static int explosionscounter = 0;// zhlt die anzahl der
												// explosionen
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (isSpiel_start()) {
				...
				/**
				 * Befehle fr das Zeichnen des Spieles
				 * ============================================================
				 */
				...
				// den Draw-Befehl fr alle Powerups, Bomben, Spieler aufrufen
				Drawing.draw();
				...
				// Malt ein weies Viereck zum uebermalen
